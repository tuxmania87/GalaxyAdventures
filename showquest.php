...
if ($ich->level == 1) {	// Fortschrittsnezige
    if ($questcounter == 3) {
        echo '<span style="font-weight:bold;color:silver;">';
    }
...
if ($ich->level == 2) {	// Fortschrittsnezige
    ...
    if ($questcounter2 == 5) {
        echo ' (fertig)</span><br /><br /><a href="showquest.php?levelup=2"><img width="32px" src="plus.png" border="0" /><font color="#7CEF0A"><b>! Level aufsteigen !</b></font><img src="plus.png" width="32px" border="0" /></a><br />';
    }
    if ($questcounter2 == 5) {
...
if ($ich->level == 3) {	// Fortschrittsnezige
    ...
    if ($questcounter3 == 3) {
        echo ' (fertig)</span><br /><br /><a href="showquest.php?levelup=3"><img width="32px" src="plus.png" border="0" /><font color="#7CEF0A"><b>! Level aufsteigen !</b></font><img src="plus.png" width="32px" border="0" /></a><br />';
    }
    if ($questcounter3 == 3) {
        echo '<br /><span class="uberschrift">Levelbelohnung:</span><br /><br />- volle Energie auf Planeten<br />- eine Sonde ( <img src="test.gif" border="0" /> )!<br />';
    }
}
if ($ich->level == 4) {	// Fortschrittsnezige
    ...
    if ($questcounter4 == 8) {
        echo ' (fertig)</span><br /><br /><a href="showquest.php?levelup=4"><img width="32px" src="plus.png" border="0" /><font color="#7CEF0A"><b>! Level aufsteigen !</b></font><img src="plus.png" width="32px" border="0" /></a><br />';
    }
    if ($questcounter4 == 8) {
        echo '<br /><span class="uberschrift">Levelbelohnung:</span><br /><br />- volle Energie auf Planeten<br />- eine Sonde ( <img src="test.gif" border="0" /> )!<br />';
    }
