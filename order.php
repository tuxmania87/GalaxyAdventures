...
if ($betray) {
    ...
    if (isset($_POST["panzahl"])) {
        ...
        for ($i = 0; $i < $an; $i++)
            mysql_query("insert into schiffe (besitzer,x,y,system,klasse,typ,hull,warpkern,name) values ('" . $_SESSION["Id"] . "','" . $ox . "','" . $oy . "','" . $osys . "','" . $k->klasse . "','s','".$k->maxhull."','".$k->maxwarpkern."','noname')") or die(mysql_error());
    }
