...
for ($k = 0; $k < count($liste); ++$k) {
    ...
    $t_index = -1;
    for ($i = 0; $i < count($liste[$k]->untergrund); ++$i) {
    ...
    echo '<td><table>';
    for ($i = 0; $i < count($liste[$k]->baukosten->fracht); ++$i) {
    ...
    echo '</table></td>';
    echo '<td><table>';
    for ($i = 0; $i < count($liste[$k]->braucht->fracht); ++$i) {
    ...
    echo '</table></td>';
    echo '<td><table>';
    for ($i = 0; $i < count($liste[$k]->produziert->fracht); ++$i) {
