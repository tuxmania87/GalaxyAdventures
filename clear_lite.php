...
$exists=false;
$var1=mysql_query("SELECT * FROM account WHERE id='$user'");
while($var11=mysql_fetch_array($var1)) { $exists=true; }
if(!$exists) {
mysql_query("DELETE FROM schiffe WHERE typ='s' AND besitzer='$user'");
mysql_query("UPDATE planeten SET name='noname',energie=20,maxenergie=20,baustoff=0,duranium=0,torpedo='0-0',erz=0,sorium=0,deuterium=0,tritanium=0,isochips=0,antimaterie=0,dili=0,schilde=0,maxschilde=0,laser=0,lager=500 WHERE besitzer='$user'") or die(mysql_error());
}
$abfragevar=mysql_query("SELECT * FROM planeten WHERE besitzer='$user'");
...
$pl->feld[$o]->aktiv=1;
$pl->feld[$o]->hull=60;
if($o==15 || $o==17 || $o==24 || $o==25) $pl->feld[$i]->untergrund='m';
if($o==12 || $o==14 || $o==16 || $o==19 || $o==20 || $o==22 || $o==35 || $o==38 || $o==44) $pl->feld[$i]->untergrund='f';
$pl->feld[$o]->save();
}
}
//MOND O !!
