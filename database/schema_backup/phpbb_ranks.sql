...
CREATE TABLE `phpbb_ranks` (
  ...
  `rank_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `rank_min` mediumint unsigned NOT NULL DEFAULT '0',
  `rank_special` tinyint unsigned NOT NULL DEFAULT '0',
  `rank_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`rank_id`)
