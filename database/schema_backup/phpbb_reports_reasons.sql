...
CREATE TABLE `phpbb_reports_reasons` (
  ...
  `reason_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `reason_description` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
