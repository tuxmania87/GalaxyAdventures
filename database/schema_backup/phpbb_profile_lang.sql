...
CREATE TABLE `phpbb_profile_lang` (
  ...
  `lang_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `lang_explain` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `lang_default_value` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
