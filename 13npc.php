...
$abfrage=mysqli_query($verbindung, "SELECT * FROM schiffe WHERE besitzer=4 AND energie>0 AND typ='s'");
...
if($wert==2) { $schiff->energie--; $schiff->x++; }
if($wert==3) { $schiff->energie--; $schiff->y++; }
