...
?>
<table><tr><td>
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="2">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="7">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="11">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="10">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="3">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="4">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="8">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="9">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="5">
...
<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="do" value="6">
...
<?php
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><input type="submit" value="zur&uuml;ck"></form>';
$wirdset=1;
}
else echo '!!ERROR!!';
} else {
...
if($checked=='m')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="planet.jpg"></td></form>';
if($checked=='z')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="wuste.png"></td></form>';
if($checked=='i')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="eisplanet.jpg"></td></form>';

if($checked=='p')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="pulsar.jpg"></td></form>';
if($checked=='x')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="black.jpg"></td></form>';

if($checked=='l')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="lava.jpg"></td></form>';

if($checked=='d')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="deut.jpg"></td></form>';
if($checked=='h')
echo '<td><img src="hstation.jpg"></td>';
if($checked=='b')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="nebel.jpg"></td></form>';
if($checked=='g')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="green.jpg"></td></form>';

if($checked=='e')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="erz.gif"></td></form>';
if($checked=='w')
echo '<form action="mappinglive.php?pw=klausx" method="post"><input type="hidden" name="deldo" value="',$x,'-',$y,'"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="wurmloch.jpg"></td></form>';



if($checked=='')
echo '<form action="mappinglive.php?pw=klausx&set=1&setx=',$x,'&sety=',$y,'" method="post"><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety,'"><td><input type="image" src="weltraum.jpg" border="0"></td></form>';
...
if ($wirdset!=1) { echo '<form action="mappinglive.php?pw=klausx" method="post">x/y<br /><input type="text" name="x1" size="2" value="',$getx,'"> / <input type="text" name="y1" size="3" value="',$gety,'"><br /><br /><input type="submit" value="Startkoordinate einstellen"></form>';
echo '<br /><table>';
echo '<tr><td></td><form action="mappinglive.php?pw=klausx" method="post"><td><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety-20,'"><input type="submit" value="20 hoch"></td></form><td></td></tr>';
echo '<tr><form action="mappinglive.php?pw=klausx" method="post"><td><input type="hidden" name="x1" value="',$getx-20,'"><input type="hidden" name="y1" value="',$gety,'"><input type="submit" value="20 links"></td></form><td></td><form action="mappinglive.php?pw=klausx" method="post"><td><input type="hidden" name="x1" value="',$getx+20,'"><input type="hidden" name="y1" value="',$gety,'"><input type="submit" value="20 rechts"></td></form></tr>';
echo '<tr><td></td><form action="mappinglive.php?pw=klausx" method="post"><td><input type="hidden" name="x1" value="',$getx,'"><input type="hidden" name="y1" value="',$gety+20,'"><input type="submit" value="20 runter"></td></form><td></td></tr>';
}
include("foot.php");
}
?>
