...
//CHEATSCHUTZ ENDE
    ...
    while($r = mysqli_fetch_array($q)) {
        ...
        echo '<td>'; $bu = new Button("kommunikation.php?accept=".$ch->id,"<span style=\"color:green;\">annehmen</span>");
        $bu->printme();
        echo '</td>';
        echo '<td>'; $bu = new Button("kommunikation.php?decline=".$ch->id,"<span style=\"color:red;\">ablehnen</span>");
        $bu->printme();
        echo '</td></tr>';
    }
    ...
    $but->printme();
    echo '<br /><br />';
    $but = new Button("map?x=180&y=110.php", "Karte");
    $but->printme();
    echo '<br />';
